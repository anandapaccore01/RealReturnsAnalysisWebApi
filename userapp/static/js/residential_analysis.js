...
////////////Below is modified custom.js of original code////////////////////////////////
$(function () {
...
$("#rent_increases").change(function () {
 ...
 $(function () {	
$("#expense_maintenance_type").change(function () {
        if ($(this).val() == "0") { 
            $("#expense_maintenance_per").show();
             $("#expense_maintenance_doll").hide();
        } 
        else if ($(this).val() == "1") {  
            $("#expense_maintenance_per").hide();
             $("#expense_maintenance_doll").show();
        } 
 ...
 $(function () {	
$("#expense_vacancy_type").change(function () {
        if ($(this).val() == "0") { 
            $("#expense_vacancy_per").show();
             $("#expense_vacancy_doll").hide();
        } 
        else if ($(this).val() == "1") {  
            $("#expense_vacancy_per").hide();
             $("#expense_vacancy_doll").show();
        } 
 ...
 $(function () {	
$("#property_mgmt_type").change(function () {
        if ($(this).val() == "0") { 
            $("#property_mgmt_per").show();
             $("#property_mgmt_doll").hide();
        } 
        else if ($(this).val() == "1") {  
            $("#property_mgmt_per").hide();
             $("#property_mgmt_doll").show();
        } 
...
$(function () {
   $('#agree_terms').click(function() { //didnot find "agree_terms" id
        if ($(this).val() == 1) {
...
$(function () {	
$("#reim_increases_type").change(function () { //"reim_increases_type" id did not find anywhere I think present for comm_reports and comm_custom.js i.e for roi
        if ($(this).val() == "0") { 
...
$(function () {	
$("#cam_increases_type").change(function () { //"cam_increases_type" id did not found may present comm_reports i.e ROI
        if ($(this).val() == "0") { 
...
$(function () {	
$("#utilities_increases_type").change(function () { //"utilities_increases_type" id didnot found and present in comm_reports i.e ROI
        if ($(this).val() == "0") { 
...
$(function () {	
$("#management_increases_type").change(function () { // "management_increases_type" id not found, and present in comm_reports i.e ROI
        if ($(this).val() == "0") { 
...
$(function () {	
$("#administrative_increases_type").change(function () { //"administrative_increases_type" id not found, present in comm_reports i.e ROI
        if ($(this).val() == "0") { 
...
$('#dynamic_field1').append('  <div class="row mt-2"  id="row'+i+'"><div class="col-12 col-lg-4 col-xl-4"> </br><label for="validationCustom09">Label</label> <i aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Enter Asset name. You need to enter complete address" class="fa fa-info-circle"></i>       <div class="input-group">   <input  type="text"  class="form-control expense_head_name"  placeholder="Enter Expense Name"  id="expense_head_name" name="expense_head_name"></div>  </div> <div class="col-12 col-lg-4 col-xl-4"> </br> <label for="validationCustom09"> Amount</label> <i aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Enter Purchase Price" class="fa fa-info-circle"></i><div class="input-group">    <div class="input-group-append"> <span class="input-group-text">$</span> </div> <input   type="number" step="any"  min="0" onblur="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" class="form-control expense_amount" id="expense_amount" name="expense_amount" placeholder="Income Amount"  oninput="dynamicUpdate();" ></div>    </div>	<div class="col-12 col-lg-4 col-xl-4"> </br><label for="validationCustom09">Frequency </label> <i aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Enter Acquired On" class="fa fa-info-circle"></i>  <div class="input-group"> <select class="form-control expense_frequency"  id="expense_frequency" onchange="dynamicUpdate();" name="expense_frequency">    <option>Choose </option>  <option value="0" selected >Equal</option> <option value="1" >Random</option></select>  </div> </div> <div class="col-12 col-lg-6 col-xl-6"></br>  <label for="validationCustom09"> Amount</label> <i aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Enter Purchase Price" class="fa fa-info-circle"></i><div class="input-group"><input   type="number" step="any" min="0" onblur="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"  class="form-control expense_increase_value"  id="expense_increase_value" name="expense_increase_value" placeholder="Increase Value"  oninput="dynamicUpdate();">       <div class="input-group-append">  <select class="form-control expense_increases_type"  id="expense_increases_type" onchange="dynamicUpdate();" name="expense_increases_type">		    <option>Choose </option> <option value="0" selected >Percentage</option>  <option value="1" >Fixed</option>	</select> </div> </div></div><div class="col-12 col-lg-6 col-xl-6"></br> <label for="validationCustom09">At Every </label> <i aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Enter Acquired On" class="fa fa-info-circle"></i><div class="input-group"> <select class="form-control  expense_increases_for_every_year"  id="expense_increases_for_every_year" onchange="dynamicUpdate();" name="expense_increases_for_every_year">	<option value="1" selected >1 Year</option> <option value="2" >2 Year</option> <option value="3" >3 Year</option><option value="4" >4 Year</option> <option value="5" >5 Year</option><option value="6"  >6 Year</option> <option value="7" >7 Year</option> <option value="8" >8 Year</option><option value="9" >9 Year</option> <option value="10" >10 Year</option></select> <div class="input-group-append"> <button type="button" name="remove" id="'+i+'" class="btn btn-sm btn-danger btn_remove">X</button></div></div> </div></div>');  
  });  
  $(document).on('click', '.btn_remove', function(){  
       var button_id = $(this).attr("id");   
...
function randomoptionadditionalExpense_edit(obj){	 
 //alert(obj);
  ...
  var table_no ='#rowe'+obj; //alert(table_no);
       i++; 			
       $(table_no).append('<div class="col-12"> <div class="row" id="rowe'+obj+''+i+'"><div class="col-12 col-lg-4 col-xl-4">  &nbsp;<div class="input-group"><input   type="number" step="any"  required class="form-control expense_increase_value"  value="0" min="0" onblur="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" id="expense_increase_value" name="expense_increase_value_edit['+obj+']" placeholder="Increase Value" oninput="dynamicUpdate();"><div class="input-group-append">   <select class="form-control expense_increases_type" required id="expense_increases_type" onchange="dynamicUpdate();" name="expense_increases_type_edit['+obj+']">   <option>Choose </option>  <option value="0" selected >Percentage</option>    <option value="1" >Fixed</option></select>    </div>         </div>        </div> 		          <div class="col-12 col-lg-4 col-xl-4">  &nbsp;<div class="input-group"><select  class="form-control expense_increases_for_every_year" required id="expense_increases_for_every_year" onchange="dynamicUpdate();" name="expense_increases_for_every_year_edit['+obj+']">	<option value="1" selected >1 Year</option> <option value="2" >2 Year</option> <option value="3" >3 Year</option><option value="4" >4 Year</option> <option value="5" >5 Year</option><option value="6"  >6 Year</option> <option value="7" >7 Year</option> <option value="8" >8 Year</option><option value="9" >9 Year</option> <option value="10" >10 Year</option></select>    &nbsp;  <button type="button" name="remove" id="'+obj+''+i+'" class="btn btn-sm btn-danger  btn_remove">X</button></div></div></div></div>');  
...
function randomoptionadditionalExpense(obj){	 
 //alert(obj);
  ...
  var table_no ='#rowe'+obj; //alert(table_no);
       i++; 			
       $(table_no).append('<div class="col-12"> <div class="row" id="rowe'+obj+''+i+'"><div class="col-12 col-lg-4 col-xl-4">  &nbsp;<div class="input-group"><input   type="number" step="any"  required class="form-control expense_increase_value"  value="0" min="0" onblur="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" id="expense_increase_value" name="expense_increase_value['+obj+']" placeholder="Increase Value" oninput="dynamicUpdate();"><div class="input-group-append">   <select class="form-control expense_increases_type" required id="expense_increases_type" onchange="dynamicUpdate();" name="expense_increases_type['+obj+']">   <option>Choose </option>  <option value="0" selected >Percentage</option>    <option value="1" >Fixed</option></select>    </div>         </div>        </div> 		          <div class="col-12 col-lg-4 col-xl-4">  &nbsp;<div class="input-group"><select  class="form-control expense_increases_for_every_year" required id="expense_increases_for_every_year" onchange="dynamicUpdate();" name="expense_increases_for_every_year['+obj+']">	<option value="1" selected >1 Year</option> <option value="2" >2 Year</option> <option value="3" >3 Year</option><option value="4" >4 Year</option> <option value="5" >5 Year</option><option value="6"  >6 Year</option> <option value="7" >7 Year</option> <option value="8" >8 Year</option><option value="9" >9 Year</option> <option value="10" >10 Year</option></select>    &nbsp;  <button type="button" name="remove" id="'+obj+''+i+'" class="btn btn-sm btn-danger  btn_remove">X</button></div></div></div></div>');  
...
$(".rent_frequency").bind( "change", function() { //alert($(this).val());
  //  $(".rent_frequency").change(function () { 
...
$(".deleteTenant").click(function(){ 
    ...
    var domain = $("#residential_data").attr("data-domain");
